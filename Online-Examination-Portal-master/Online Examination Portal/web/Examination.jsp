...
<div id="ExamPageHeader" style="height: 10%; width:100%; position: fixed; top: 0; padding-top: 5px">
...
<div id="ExamPageQuestionPaper" style="height: 78%; width:99.5%; position: fixed; padding-top: 78px">
    <iframe src="QuestionPaper.jsp" id="QuestionPaperFrame" width="100%" height="100%" frameborder="0" name="QuestionPaper"></iframe>
    <hr/>
    <a href="javascript:void(0)" onClick="getPreviousQuestion()" style="padding-left: 20px">Previous Question</a>
    <a href="javascript:void(0)" style="padding-left: 20px" onClick="getNextQuestion()">Next Question</a>
    
    <br>
<b id="testID"></b>
</div>
<a href="submitExamConfirmation.jsp" style="position: absolute; bottom: 0; right: 0; padding-bottom: 18px; padding-right: 20px">Finish Exam</a>
