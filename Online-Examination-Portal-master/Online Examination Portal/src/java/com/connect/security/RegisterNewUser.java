...
public class RegisterNewUser extends HttpServlet {
    ...
    String dbUrl = "jdbc:mysql://localhost:3306/online_exam_portal?useSSL=false&serverTimezone=UTC";
...
String userLoginCredentialsInsertQuery = "";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Connection con = DriverManager.getConnection (dbUrl,"root","password");//username,password
        ...
        PreparedStatement insertLoginCredentials;
        userLoginCredentialsInsertQuery="INSERT INTO login_credentials (Username, Password) VALUES (?, ?)";
        insertLoginCredentials = con.prepareStatement(userLoginCredentialsInsertQuery);
    
        insertLoginCredentials.setString(1, UserName);
        insertLoginCredentials.setString(2, Password);
    
        int loginoutput = insertLoginCredentials.executeUpdate();       
        //--------------------------------------------------------------------------------
        ...
        out.println("<br>Password &nbsp&nbsp&nbsp&nbsp&nbsp: "+Password);
         ...
         out.println("<br><br> Rows Updated are :  "+loginoutput);
